--[[
    This is Vape but edited and written by KaterHub.
...
ui.Name = tostring(math.random(1000,9999)) .. "-" .. tostring(math.random(1000,9999)) .. "-" .. tostring(math.random(1000,9999))
